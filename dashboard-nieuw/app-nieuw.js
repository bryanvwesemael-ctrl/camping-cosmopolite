...
async function editGegevens(id){
  ...
  openModal('Boeking bewerken',
    ...
    '<div class="toggle-row"><span class="sl">🔒 Dossier langer bewaren <span style="opacity:.6;font-size:11px;font-weight:400;">uitzondering op de bewaartermijnen (foto 90 dagen, dossier 7 jaar) — enkel bij een goede reden</span></span><input type="checkbox" id="eHold" '+(b.dataHold?'checked':'')+' onchange="document.getElementById(\'eHoldRedenWrap\').style.display=this.checked?\'block\':\'none\'"></div>'+
